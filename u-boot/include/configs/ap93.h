...
#define	CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:02 rootfstype=jffs2 init=/sbin/init mtdparts=ar7240-nor0:248k(u-boot),8k(u-boot-env),3712k(firmware),64k(ART)"

/* default mtd partition table */
#undef MTDPARTS_DEFAULT
#define MTDPARTS_DEFAULT    "mtdparts=ar7240-nor0:248k(u-boot),8k(u-boot-env),3712k(firmware),64k(ART)"

#undef CFG_PLL_FREQ
#define CFG_PLL_FREQ	CFG_PLL_380_380_190
...
/* choose eth1 first for tftpboot interface added by tiger 07/20/09
...
#define DEFAULT_FLASH_SIZE_IN_MB 4
...
/*
 ...
 #define CONFIG_COMMANDS (CFG_CMD_LOADB | CFG_CMD_MEMORY | CFG_CMD_FLASH | CFG_CMD_NET | CFG_CMD_ENV)
 */
