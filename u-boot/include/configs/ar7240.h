...
//#define	CFG_LOAD_ADDR		0xa1000000
#define		CFG_LOAD_ADDR		0x80f00000		/* default load address	*/

#define CFG_MEMTEST_START	0x80100000
#undef CFG_MEMTEST_START
#define CFG_MEMTEST_START       0x80f00000
#define CFG_MEMTEST_END		0x81f00000
...
#define MTDPARTS_DEFAULT    "mtdparts=ar7240-nor0:256k(u-boot),384k(experi-jffs2)"
